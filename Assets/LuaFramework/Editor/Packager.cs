...
public class Packager {
    ...
    static void HandleLuaBundle() {
        ...
        AddBuildMap("lua/lua" + AppConst.ExtName, "Assets/" + AppConst.LuaTempDir);
    ...
    static void HandleBundle() {
        ...
        //AddBuildMap("prompt_asset" + AppConst.ExtName, "Assets/LuaFramework/Examples/Textures/Prompt");
        //AddBuildMap("shared_asset" + AppConst.ExtName, "Assets/LuaFramework/Examples/Textures/Shared");
        AddBuildMap("fonts" + AppConst.ExtName, "Assets/Builds/Fonts");
        //AddBuildMap("scenes" + AppConst.ExtName, "Assets/Builds/Scenes");
        AddBuildMap("prefabs" + AppConst.ExtName, "Assets/Builds/Prefabs");
        DirectoryInfo root = new DirectoryInfo("Assets/Builds/UI");
        DirectoryInfo[] files = root.GetDirectories();
        foreach (DirectoryInfo file in files)
        {
            DirectoryInfo[] targetFiles = file.GetDirectories();
            foreach (DirectoryInfo targetFile in targetFiles)
            {
                string directoryPath = "Assets/Builds/UI/" + file.Name + "/"+ targetFile.Name;
                AddBuildMap(targetFile.Name + AppConst.ExtName, directoryPath);
            }
        }
    }
